...
st.caption(
    ...
    "Negotiation more than 30 days, JBP Signed more than 60 days, Live Campaign more than 60 days, "
    "Renewal more than 30 days. At first, these thresholds are set from experience and judgement. "
    "In future, once enough deal history has been generated, this would convert to a predictive "
    "model built on a real data pipeline — trained on actual won/lost/stalled outcomes — to flag "
    "at-risk deals based on learned patterns rather than fixed rules."
)
